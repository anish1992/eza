...
public class eza extends JFrame {
	...
	public eza() {
		...
		Dash.add(on_image);
		on_image.setBounds(730, 10, 74, 50);
		...
		lights_onoff_button.setBounds(650, 10, 82, 20);
		
//kmod
	final javax.swing.JToggleButton jToggleButton2 = new javax.swing.JToggleButton();
		jToggleButton2.setFont(new java.awt.Font("SansSerif", 1, 12));
		jToggleButton2.setText("AUTO");
		jToggleButton2.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				// Set Manual Mode
				if (jToggleButton2.isSelected()) {
					jToggleButton2.setText("MANUAL");
					if (lights_onoff_button.isSelected() == true) {
						try {
							lights_onoff_button.setText("OFF?");
						...
						try {
							lights_onoff_button.setText("ON?");
							on_image.setIcon(new ImageIcon("./images/bulb-icon.png"));
							Thread.sleep(500);
		...
		Dash.add(jToggleButton2);
		jToggleButton2.setBounds(500, 10, 140, 30);

		// System Mode
		final JLabel sys_mode = new JLabel();
		sys_mode.setFont(new java.awt.Font("SansSerif", 1, 14));
		sys_mode.setForeground(new java.awt.Color(204, 204, 204));
		sys_mode.setText("SYSTEM ON: ");
		Dash.add(sys_mode);
		sys_mode.setBounds(163, 45, 202, 20);
		...
		Dash.add(light_mode);
		light_mode.setBounds(563, 45, 202, 20);
//kmod end
